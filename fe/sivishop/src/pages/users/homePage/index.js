    ...
    return (
        <>
            ...
            <div className="container container_categories_slider">
                <Carousel responsive={responsive} className="mb-5 categories_slider">
                    {
                ...
                <div className="container">
                     <h1 className="text-center">Sách Kinh Tế</h1>
                </div>
                <Carousel responsive={responsive} className="mt-5 categories_slider">
                    {
                        slidersItem.map((item, key) => (
                            <div 
                                className="categories_slider_item"
